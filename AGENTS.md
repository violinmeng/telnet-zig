...
This project requires **Zig 0.13.0**. The Zig compiler is installed at `~/zig/zig-linux-x86_64-0.13.0/zig` and added to `PATH` via `~/.bashrc`. Verify with `zig version`.
...
- The CI workflows reference Zig 0.11.0 but the project README and codebase require 0.13.0. Use 0.13.0.
